    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-zinc-900/90 to-zinc-800/90 border-t border-zinc-800 text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary-500 mix-blend-multiply filter blur-[128px] animate-float"></div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-800 flex items-center justify-center hover:bg-primary-600 transition-colors border-l-4 border-transparent hover:border-primary-400">
          ...
          <div className="pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-sm">
                © 2024 ScaleNodes. All rights reserved. Made with ❤️ in Kenya.
              </p>
